...
"But Valderi, we asked you to refactor it, there's MORE lines of code now!" True. While the main function has been reduced to a half a dozen lines, 
the overall code length has increased. In my time as a Sr. Developer and Team lead, having to code review dozens of commits every couple of weeks, 
I've come to realize that "sleek" code does not always make for "clean and readable" code. It often times takes much longer to carefully read 
and understand what a sleek code is doing than one that's a bit more verbose, but you can understand what it is doing by just skimming it. */
